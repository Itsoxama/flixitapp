                    ...
                    <div className="userstable">
                        <div className="subtable">
                            <div className="toprow toprow2">
                                ...
                                <p className='pprofession' >Location</p>
                                ...
                                ? currentItems.map((val, index) => (
                                    <>
                                        <div className="toprow toprow3">
                                            ...
                                            <p className='pprofession' >{val.location.substring(0, 20)}..</p>
                                            ...
                                            <p className='pphone' ><BiPencil
                                                onClick={e => editprofile(
                                                    ...
                                                    val.bio,
                                                    val.services
                                                )} className='ai1' /> <AiFillDelete onClick={e => deleted(val._id)} className='ai2' /> 
                                                </p>
